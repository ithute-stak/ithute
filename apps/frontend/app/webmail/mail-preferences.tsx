    ...
    <div className="fixed inset-0 z-[110] flex justify-end bg-slate-950/20 backdrop-blur-[2px]" onMouseDown={(event) => { if (event.currentTarget === event.target) onClose(); }}>
      <aside className="h-full w-full max-w-[430px] overflow-y-auto border-l border-slate-200 bg-[#f8fafd] shadow-[-22px_0_70px_rgba(15,23,42,.16)] dark:border-white/10 dark:bg-[#101817]">
        ...
        <div className="space-y-7 p-5">
          ...
          <section>
            <h2 className="text-xs font-black uppercase tracking-[.15em] text-slate-500 dark:text-slate-400">Reading layout</h2>
          ...
          <section>
            <h2 className="text-xs font-black uppercase tracking-[.15em] text-slate-500 dark:text-slate-400">Inbox density</h2>
            <div className="mt-3 grid grid-cols-2 gap-2">
          ...
          <section>
            <h2 className="text-xs font-black uppercase tracking-[.15em] text-slate-500 dark:text-slate-400">Reading</h2>
          ...
          <button type="button" onClick={onReset} className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-xs font-bold text-slate-600 hover:bg-slate-50 dark:border-white/10 dark:bg-white/[.035] dark:text-slate-300 dark:hover:bg-white/[.06]"><RotateCcw size={15} /> Reset layout preferences</button>
        </div>
      </aside>
    </div>
  );
