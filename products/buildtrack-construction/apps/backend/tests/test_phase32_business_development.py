...
def test_phase32_business_development_contract_is_wired():
 root=Path(__file__).resolve().parents[1];api=(root/"app/api/v1/business_development.py").read_text();models=(root/"app/models/business_development.py").read_text();migration=(root/"alembic/versions/0033_phase32_business_dev.py").read_text();ui=root.parents[0]/"frontend/app/business-development/page.tsx"
