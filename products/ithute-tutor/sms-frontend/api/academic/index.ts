...
export type Assessment = { id: string; school_id: string; academic_year_id: string; term_id: string; class_id: string; subject_id: string; teacher_id?: string | null; title: string; assessment_type: string; assessment_date: string; max_score: string; weight: string; is_published: boolean; is_locked: boolean }
